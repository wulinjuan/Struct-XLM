...
def mlqa_evaluate(examples, predictions, lang):
    f1 = exact_match = 0
    for example in examples:
        ...
        exact_match += metric_max_over_ground_truths(exact_match_score, prediction, ground_truths, lang)
        f1 += metric_max_over_ground_truths(f1_score, prediction, ground_truths, lang)

    exact_match = 100.0 * exact_match / len(examples)
    f1 = 100.0 * f1 / len(examples)
