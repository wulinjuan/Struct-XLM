from transformers import RobertaPreTrainedModel, apply_chunking_to_forward
...
from transformers.models.roberta.modeling_roberta import RobertaEmbeddings, RobertaPooler, \
    _CHECKPOINT_FOR_DOC, _CONFIG_FOR_DOC, RobertaOutput, RobertaIntermediate, RobertaSelfOutput, \
...
class RobertaSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if struct_action_probs is not None:
            ...
            attention_probs = attention_probs.masked_fill(attention_probs == 0, -1e+30)
